...
public class TransactionManager : ITransactionManager
{
    ...
    private TransactionDisplayService displayService = new TransactionDisplayService();
    ...
    public virtual void Populate(int count)
    {
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            //DateTime randomDate = startDate.AddDays(random.Next(0, (int)timeSpan.TotalDays));
